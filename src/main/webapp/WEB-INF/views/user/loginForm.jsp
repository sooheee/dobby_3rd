...
<section class="container">
    <div class="login-title">
        <img src="./img/user/login_img/logo.jpg" style="width: 450px; display: block; margin-left: auto; margin-right: auto; margin-top: 20px" class="login-img" />
...
<%--                <rm>--%>
                    ...
                    <div class="etc_login">
                        <button class="kakao-btn" type="button" data-key="KA" data-val="KAKAO">
                            <img src="./img/user/login_img/kakao_login_large_wide２.png" id="kakao-login-btn" alt  style="width: 510px; display: block; margin-left: auto; margin-right: auto;">
                        </button>
